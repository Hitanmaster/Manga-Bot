...
bot = Client('bot',
             api_id=int(env_vars.get('29324866')),
             api_hash=env_vars.get('2d41c2224fd999a81f6c90ce68b0454a'),
             bot_token=env_vars.get('7232250192:AAGdo_LIXI48DBr12YfVSipegF3BfxONKpw'),
